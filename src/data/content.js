        ...
        tiers: [
            {
                ...
                features: [
                    ...
                    { label: "Daily Profile Monitoring", included: true },
                    { label: "Google Maps Optimization", included: false },
                    { label: "Paid Social Ads", included: false },
                    { label: "AI Lead Qualifications", included: false },
            ...
            },
            {
                ...
                features: [
                    ...
                    { label: "Daily Profile Monitoring", included: true },
                    { label: "Targeted Lead Gen Campaign", value: "1 Camp." },
                    { label: "Ad Audience Strategy Setup", included: true },
                    { label: "Google Maps Optimization", included: true },
                    { label: "AI Lead Qualifications", included: false },
                    { label: "Contract Duration", value: "6 months" },
                ]
            },
            {
                ...
                features: [
                    ...
                    { label: "StoryBrand Profile Optimization", included: true },
                    { label: "Monthly Content Calendar & Strategy", included: true },
                    { label: "Proactive Community Building", included: true },
                    { label: "Targeted Lead Gen Campaigns", value: "2 Camp." },
                    { label: "AI Auto-Replies (FB/IG DMs)", included: true },
                    { label: "Google Maps Optimization", included: true },
                    { label: "Contract Duration", value: "6 months" },
                ]
            },
            {
                ...
                features: [
                    ...
                    { label: "Localized Bilingual Copy", value: "EN + AR" },
                    { label: "Proactive Community Building", included: true },
                    { label: "Full Paid Social Ads Management", included: true },
                    { label: "Google Ads Management", value: "20 Keywords" },
                    { label: "Ad Landing Page Consultation", included: true },
                    { label: "AI Lead Qualifications Chatbot", included: true },
                    { label: "Google Maps Optimization", included: true },
                    { label: "Contract Duration", value: "6 months" },
                ]
            },
            {
                ...
                features: [
                    ...
                    { label: "Monthly Commercial Photoshoot", included: true },
                    { label: "Localized Bilingual Copy", value: "EN + AR" },
                    { label: "Full Paid Social & Google Ads", included: true },
                    { label: "SEO Management", value: "20 Keywords" },
                    { label: "AI Lead Qualifications Chatbot", included: true },
                    { label: "Live Data Dashboard Setup", value: "Looker" },
                    { label: "ERPNext / CRM Lead Sync", included: true },
                    { label: "Google Maps Optimization", included: true },
                    { label: "Contract Duration", value: "6 months" },
                ]
            }
